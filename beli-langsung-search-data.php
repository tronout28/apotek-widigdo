...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "barang_stock > 0 && barang_harga > 0 && barang_stock >= satuan_isi_1 && barang_kadaluarsa > '".$tanggalHariIni."' && barang_cabang = $cabang " )
