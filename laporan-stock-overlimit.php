...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Laporan Stok Over Limit</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="bo">Home</a></li>
                        <li class="breadcrumb-item active">Stok Over Limit</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Laporan Stok Over Limit</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="GET">
                            <div class="form-group">
                                ...
                                <input type="number" name="limit" id="limit" class="form-control" value="<?= isset($_GET['limit']) ? $_GET['limit'] : 100; ?>">
                            </div>
                            <button type="submit" class="btn btn-primary">Tampilkan</button>
                        </form>
                        <hr>
                        <div class="table-auto">
                            <table id="laporan-stok-over-limit" class="table table-bordered table-striped table-laporan">
                                <thead>
                                    <tr>
                             ...
                             WHERE barang_cabang = '" . $sessionCabang . "' AND barang_stock > $limit ORDER BY barang_stock DESC");
...
<script>
    $(function() {
        $("#laporan-stok-over-limit").DataTable();
    });
</script>
</body>
