            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Kondisi Stok</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Laporan Kondisi Stok Barang</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="table-auto">
                            <table id="laporan-kondisi-stok" class="table table-bordered table-striped table-laporan">
                                <thead>
                                    <tr>
                             ...
                             WHERE barang_cabang = '" . $sessionCabang . "' ORDER BY barang_stock ASC");
                                    while ($rowProduct = mysqli_fetch_array($queryProduct)) {
                                        $kondisi = ($rowProduct['barang_stock'] < 10) ? "Stok Rendah" : "Stok Aman";
                                    ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            ...
                                            <td>
                                                <span class="badge <?= ($kondisi == 'Stok Rendah') ? 'badge-danger' : 'badge-success'; ?>">
                                                    <?= $kondisi; ?>
                                                </span>
                                            </td>
                                        </tr>
...
<script>
    $(function() {
        $("#laporan-kondisi-stok").DataTable();
    });
</script>
</body>
